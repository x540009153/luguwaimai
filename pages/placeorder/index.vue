		...
		<view class="place-view">
			...
			<view class="goods-address" v-if="!addreing" @click="address">
				...
				<view class="goods-address-in">
					<view>{{addressing.provinceName}}{{addressing.cityName}}{{addressing.countyName}}{{addressing.detailInfo}}</view>
...
<script>
	...
	export default {
		...
		//接收传过来的数据
		onLoad(e) {
			let order = JSON.parse(e.ide)
			//商品数据
			this.allorder = order.allorder
			//商品总金额
			this.payment = order.payment
			//配送费
			this.physical = order.physical
			//用户openid
